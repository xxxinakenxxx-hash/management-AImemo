(function () {
  ...
  function openCalendarDraft(todo, selectedDate) {
    if (!validDate(todo.due_date) && !selectedDate) {
      const dateDialog = $('calendar-date-dialog'); $('calendar-date-input').value = ''; $('calendar-date-picker').value = '';
