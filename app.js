(function () {
  ...
  function openCalendarDraft(todo) {
    let date = validDate(todo.due_date) ? todo.due_date : prompt('予定日をYYYY-MM-DDで入力してください。');
